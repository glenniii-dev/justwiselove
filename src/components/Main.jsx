...
export default function Main() {
  return (
    <main className="bg-zinc-900 text-white max-w-[400px] sm:max-w-[540px] md:max-w-[668px] lg:max-w-[924px] py-5 flex items-center h-auto px-5 rounded-lg text-center flex-col my-12 mx-auto justify-self-center wrap-break-word">
